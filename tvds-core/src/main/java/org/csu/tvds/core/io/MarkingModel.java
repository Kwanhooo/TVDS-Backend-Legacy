...
@Component
public class MarkingModel extends ModelDispatcher<String, Boolean> {
    private static final String JSON_PATH = AI_BASE + "tvds-registration/images/template/X70/part_index.json";

    {
        modelPath = AI_BASE + "tvds-registration/marker.py";
    ...
    public Output<Boolean> dispatch(Input<String> input) {
        ...
        try {
            ...
            template.setValues(new String[]{JSON_PATH, imagePath, outputPath});
